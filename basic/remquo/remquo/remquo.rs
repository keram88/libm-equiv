...
pub fn rust_remquo(mut x: f64, mut y: f64) -> (f64, i32) {
...
extern "C" {
    // Musl
    fn musl_remquo(x: f64, y: f64, quo: &mut i32) -> f64;
}
...
fn musl_rust() {
    ...
    let rem1 = unsafe { musl_remquo(x1, x2, &mut quo1) };
    let (rem2, quo2) = rust_remquo(x1, x2);
