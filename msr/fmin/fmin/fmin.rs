...
pub fn rust_fmin(x: f64, y: f64) -> f64 {
...
fn musl_smack() {
    ...
    let y = unsafe { musl_fmin(x1, x2) };
    let z = unsafe { fmin(x1, x2) };
    verifier_assert!(y == z);
}
