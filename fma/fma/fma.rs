...
pub fn rust_fma_arg(x: f64, y: f64, z: f64) -> f64 {
    let x1p63: f64 = f64::from_bits(0x43e0000000000000); // 0x1p63 === 2 ^ 63
...
extern "C" {
    fn musl_fma_arg(x: f64, y: f64, z: f64) -> f64;
}
...
fn musl_rust() {
    ...
    let z: f64 = 0.0f64.verifier_nondet();
    ...
    let arg1 = unsafe { musl_fma_arg(x, y, z) };
    let arg2 = rust_fma_arg(x, y, z);

    verifier_assert!(arg1 == arg2);
}
